...
nacl_rules = {
  ...
  application = {
    ...
    ingress_rules = [
      ...
      { protocol = "tcp", rule_no = 120, action = "allow", cidr_block = "0.0.0.0/0", from_port = 443, to_port = 443 },
      # DNS for service discovery
      { protocol = "tcp", rule_no = 130, action = "allow", cidr_block = "0.0.0.0/0", from_port = 53, to_port = 53 },
      { protocol = "udp", rule_no = 140, action = "allow", cidr_block = "0.0.0.0/0", from_port = 53, to_port = 53 }
    ]
    egress_rules = [
      { protocol = "tcp", rule_no = 100, action = "allow", cidr_block = "0.0.0.0/0", from_port = 1024, to_port = 65535 },
      ...
      # Allow DNS queries
      { protocol = "udp", rule_no = 120, action = "allow", cidr_block = "0.0.0.0/0", from_port = 53, to_port = 53 },
      { protocol = "tcp", rule_no = 130, action = "allow", cidr_block = "0.0.0.0/0", from_port = 53, to_port = 53 },
      # NTP for time sync
      { protocol = "udp", rule_no = 140, action = "allow", cidr_block = "0.0.0.0/0", from_port = 123, to_port = 123 },
      # Allow all outbound to AWS services via endpoints
      { protocol = "-1", rule_no = 150, action = "allow", cidr_block = "0.0.0.0/0", from_port = 0, to_port = 0 }
    ]
  }
